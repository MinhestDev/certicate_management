  ...
  <AuthContainer>
    <div class="w-full bg-white lg:w-6/12 xl:w-5/12">
      ...
      >
        ...
        <h4 class="w-full text-3xl font-bold">Đăng ký</h4>
        <p class="text-sm text-gray-500">
          hoặc nếu bạn có tài khoản, có thể
          <router-link
            to="/signin"
        ...
        <div class="relative w-full mt-10 space-y-8">
          <div class="relative">
            <label class="font-medium text-gray-900">Tên đầy đủ</label>
            <input
              type="text"
          ...
          <div class="relative grid grid-cols-2 gap-2">
            <div class="relative" v-if="!metaMaskLoginSupported">
              <label class="font-medium text-gray-900">Mật khẩu</label>
              <input
                type="password"
                class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50"
                data-primary="blue-600"
            ...
            <div class="relative" v-if="!metaMaskLoginSupported">
              <label class="font-medium text-gray-900">Xác nhận mật khẩu</label>
              <input
                type="password"
                class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50"
                data-primary="blue-600"
